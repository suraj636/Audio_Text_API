...
async def process_audio_endpoint(input_file: UploadFile = File(...), target_sr: int = 8000, language_code: str = "en-US"):
    ...
    try:
        with tempfile.NamedTemporaryFile(suffix=".wav", delete=False) as temp_audio_file:
            ...
            #logging.info("We can say that the audio has been converted into wav")
        ...
        #logging.info("Header is initialized for sending the request to azure")
        headers = {
        ...
        response = requests.post(azure_speech_api_url, headers=headers, params=params, data=audio_data)
